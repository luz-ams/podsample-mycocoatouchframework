#
#  Be sure to run `pod spec lint MyCocoaTouchFramework.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Luz" => "luli2it@gmail.com" }
  # Or just: s.author    = "Luz Racca"
  # s.authors            = { "Luz Racca" => "luli2it@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Luz Racca"
  ...
  # s.resource  = "icon.png"
  s.resources = "MyCocoaTouchFramework/**/*.{xib}"
